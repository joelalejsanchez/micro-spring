...
import com.ssdd.entities.Category;
import com.ssdd.entities.Company;
import com.ssdd.repositories.CompanyRepository;
...
public class CompanyServiceImpl implements CompanyService {
  ...
  @Override
  public Company[] readAll() {
    return (Company[]) this.companyRepository.findAll().toArray();
  }
